...
_COMMON_NAMES = frozenset(
    ["александр", "саш", "алекс", "алексе", "лёш", "леш", "андре", "андрю", "антон", "артём", "артем", "борис", "вадим", "валер", "васил", "вас", "виктор", "вит", "влад", "владимир", "вов", "волод", "вячеслав", "слав", "гриш", "григори", "денис", "дим", "дмитри", "евгени", "жен", "егор", "иван", "ван", "игор", "илья", "иль", "кирилл", "кост", "константин", "макс", "максим", "миш", "михаил", "никит", "никола", "кол", "олег", "паш", "павел", "пётр", "пет", "роман", "ром", "руслан", "семён", "сергей", "серёж", "сереж", "станислав", "стас", "тимур", "фёдор", "федор", "юр", "юри", "ярослав", "алин", "алёна", "алена", "анастаси", "наст", "ан", "анн", "вер", "виктори", "вик", "дар", "дарь", "екатерин", "кат", "елен", "лен", "елизавет", "лиз", "ирин", "ир", "ксени", "ксюш", "лили", "любов", "люб", "мари", "маш", "марин", "надежд", "над", "натали", "наташ", "ольг", "ол", "полин", "свет", "светлан", "софи", "сон", "тан", "татьян", "юли", "юл", "мам", "пап", "бабушк", "бабк", "дедушк", "дед", "брат", "сестр", "тёт", "тет", "дяд"]
)
